        ...
        <div className="flex flex-col gap-10 md:flex-row">
          <motion.aside className="lg:w-5/6" variants={fadeIn}>
            <p className="text-[.9rem] opacity-85 lg:opacity-90 font-[450] text-[#222222] dark:text-white leading-relaxed">
              I'm a Software Engineer from Winnipeg, Canada, with five years of experience in full-stack development, specializing in PHP,
          ...
          <aside className="w-2/6 flex flex-col gap-y-4 text-start">
            <div className="flex flex-col gap-y-1 items-start">
              ...
              <div className="flex items-center gap-x-3">
                <span className="text-[.85rem] opacity-80 text-[#222222] dark:text-white">Winnipeg, Canada</span>
                <motion.figure
